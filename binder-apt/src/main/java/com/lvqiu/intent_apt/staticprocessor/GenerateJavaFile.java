...
public class GenerateJavaFile {
    ...
    public GenerateJavaFile(Filer mFiler, Messager messager) {
        this.mFiler = mFiler;
        this.messager = messager;
    }

    public  void generate(List<InjectDesc> injectDescs  ) {
    ...
    private   void generateFactory(ArrayList<InjectDesc> classes ,TypeName base ){
        ...
        for (InjectDesc ac:  classes) {
            ClassName activity= getClassName(ac.activityName) ;
    ...
    private   void generateViewBinder(InjectDesc injectDesc )  {
        ...
        ClassName activity= getClassName(injectDesc.activityName);
